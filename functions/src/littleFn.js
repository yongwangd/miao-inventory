...
var valueContains = exports.valueContains = function valueContains(str, ob) {
  ...
  return (0, _values2.default)(ob).filter(function (v) {
    ...
    if (_ramda2.default.is(Object, v)) {
      return valueContains(str, v);
    }
    return String(ignoreCase ? v.toLowerCase() : v).includes(ignoreCase ? str.toLowerCase() : str);
  });
};
...
var toggleArrayItem = exports.toggleArrayItem = function toggleArrayItem() {
